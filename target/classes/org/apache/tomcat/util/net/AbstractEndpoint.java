...
public abstract class AbstractEndpoint<S, U> {
    ...
    protected enum BindState {
        UNBOUND(false, false), BOUND_ON_INIT(true, true), BOUND_ON_START(true, true), SOCKET_CLOSED_ON_STOP(false,
                true);
     ...
     * selected the socket.
     * 创建SocketProcessorBase对象。该对象是实际处理socket读写操作的
     * 把 SocketProcessorBase 线程，放到线程池中执行
     *
