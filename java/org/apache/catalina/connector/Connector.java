...
public class Connector extends LifecycleMBeanBase {
     ...
     */
    public static final boolean RECYCLE_FACADES = Boolean.parseBoolean(
            System.getProperty("org.apache.catalina.connector.RECYCLE_FACADES", "false"));
    ...
    public Connector(String protocol) {
        ...
        if (Boolean.parseBoolean(
                System.getProperty("org.apache.tomcat.util.buf.UDecoder.ALLOW_ENCODED_SLASH", "false"))) {
    ...
    private EncodedSolidusHandling encodedSolidusHandling = UDecoder.ALLOW_ENCODED_SLASH ?
